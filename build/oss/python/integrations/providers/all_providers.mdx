...
<Columns cols={3}>
    ...
    <Card
        title="ChronoVec"
        href="https://mchl-labs.github.io/chronovec/integrations/langchain"
        icon="link"
    >
    ...
    <Card
        title="Hubris"
        href="https://hubris.pw/docs/integrations/langchain"
        icon="link"
    >
    ...
    <Card
        title="Plivo"
        href="https://github.com/plivo-dev/langchain-plivo-tools"
        icon="link"
    >
...
<Card
    ...
    <Card
        title="SereneDB"
        href="https://serenedb.com/docs/clients/langchain-serenedb"
        icon="link"
    >
    ...
    <Card
        title="Traccia"
        href="https://traccia.ai/docs/integrations/langchain/"
        icon="link"
    >
    ...
    <Card
        title="TypesenseVectorStore"
        href="https://github.com/typesense/langchain-typesense#readme"
        icon="link"
    >

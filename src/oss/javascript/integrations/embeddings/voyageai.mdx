...
To access VoyageAI by MongoDB embedding models you'll need to create a VoyageAI by MongoDB account, get an API key, and install the `@langchain/mongodb` integration package.
